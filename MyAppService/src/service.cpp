        ...
        m_invokeManager(new InvokeManager(this))
{
    ...
    m_notify->setTitle("MyApp Service");
    m_notify->setBody("MyApp service requires attention");

    bb::system::InvokeRequest request;
    request.setTarget("com.example.MyApp");
...
{
    if (request.action().compare("com.example.MyAppService.RESET") == 0) {
        triggerNotification();
    }
}
