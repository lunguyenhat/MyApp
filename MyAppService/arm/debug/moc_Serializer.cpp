...
#include "../../src/T2W API/Serializer.h"
...
static const char qt_meta_stringdata_Serializer[] = {
    "Serializer\0"
};
...
const QMetaObjectExtraData Serializer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Serializer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Serializer,
      qt_meta_data_Serializer, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Serializer::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Serializer))
